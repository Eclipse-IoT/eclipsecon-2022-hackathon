...
then
    ...
    pre-provision provision --node-address 0x${address} --network-key 0B5E6760156116BAB83115D4C1BFB480 --application-key 8E0A245C38A136E7D6E8429D562DA959 --device-key ${devkey} --chip nRF52833_xxAA
